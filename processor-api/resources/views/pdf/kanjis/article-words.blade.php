...
@section('links')
    <div class="col-md-6">
        <a class="text-primary float-left" href="{{ 'localhost:3000/article/' . $article_id }}" target="_blank">Read Article
            online</a>
    </div>
    <div class="col-md-6">
...
@section('content')
    <div class="col-md-12 mb-5 article-content">
        <h3>{{ $title_jp }}</h3>
        <p>{{ $content_jp }}</p>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach ($wordList as $singleWord)
                            <tr>
                                <td lang="ja" id="kanjiTd"> <a href="{{ 'localhost:3000/word/' . $singleWord->id }}"
                                        target="_blank"> {{ $singleWord->word }} </a></td>

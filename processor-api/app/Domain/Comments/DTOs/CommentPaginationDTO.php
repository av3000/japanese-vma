 ...
 *
 * For a page of top-level comments, `total` counts conversations rather than
 * rows: replies travel inside their parent, never as page entries.
 */
final readonly class CommentPaginationDTO
{

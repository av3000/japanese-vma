...
export const SettingGroup: React.FunctionComponent<SettingGroupProps> = ({ variables, variant, hasNoTitle }) => {
	...
	return (
		<article className={classNames(styles.wrapper, variant && styles['variant' + capitalize(variant)])}>

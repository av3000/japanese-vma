...
export interface LinkExternalProps extends LinkBaseProps, React.AnchorHTMLAttributes<HTMLAnchorElement> {
...
export const LinkExternal: React.FunctionComponent<LinkExternalProps> = (props) => {
	...
	if (linkUrl !== undefined || mailTo !== undefined) {
		const showExternalIcon = target === '_blank' && typeof children === 'string' && !hideExternalIcon;

...
export type ObjectTemplateType = (typeof ObjectTemplateType)[keyof typeof ObjectTemplateType];

/**
 * Usage: `ObjectTemplateTypeLabel[ObjectTemplateType.ARTICLE];`
 */
export const ObjectTemplateTypeLabel = {
...
} satisfies Record<ObjectTemplateType, string>;

/**
 * Usage: `ObjectTemplateTypeLegacyId[ObjectTemplateType.COMMENT];`
 */
export const ObjectTemplateTypeLegacyId = {
...
} satisfies Record<ObjectTemplateType, number>;

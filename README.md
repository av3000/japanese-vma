...
Swagger docs with [scramble.dedoc.co](https://scramble.dedoc.co/) for autogenerated routes at [http://localhost:8080/docs/api](http://localhost:8080/docs/api)
...
- [ ] Design a way to offload scanning algorithm from client to server potentially with queue mechanism.
